...
class TestRecipes(unittest.TestCase):
    ...
    def test_valid_json_load_recipes(self):
        ...
        recipes_data = [{"id": 1,"name": "Mix Berry Smoothie","description": "A delicious and healthy blended drink made from a variety of fresh or frozen berries","category": "desserts","rating": 5,"image_url": "https://www.jessicagavin.com/wp-content/uploads/2020/07/berry-smoothie-8-1200.jpg"},{"id": 2,"name": "Frozen Yogurt Bark","description": "A tasty and healthy snack that is made from a base of creamy yogurt, typically Greek yogurt, and frozen fruit. ","category": "desserts","rating": 4,"image_url": "https://www.notenoughcinnamon.com/wp-content/uploads/2021/03/Healthy-Frozen-Yogurt-Bark-3-500x500.jpg"}]
    ...
    def test_filter_by_name_recipes(self):
        ...
        recipes_expected = [{"id": 1,"name": "Mix Berry Smoothie","description": "A delicious and healthy blended drink made from a variety of fresh or frozen berries","category": "desserts","rating": 5,"image_url": "https://www.jessicagavin.com/wp-content/uploads/2020/07/berry-smoothie-8-1200.jpg"}]
        self.assertEqual(recipes_expected, recipes_filtered_data)

    def test_filter_by_category_recipes(self):
        recipe_management = RecipeManagement()
        category = "desserts"
        recipes_filtered_data = recipe_management.filter_recipes("", category, "")
        recipes_expected = [{"id": 1,"name": "Mix Berry Smoothie","description": "A delicious and healthy blended drink made from a variety of fresh or frozen berries","category": "desserts","rating": 5,"image_url": "https://www.jessicagavin.com/wp-content/uploads/2020/07/berry-smoothie-8-1200.jpg"},{"id": 2,"name": "Frozen Yogurt Bark","description": "A tasty and healthy snack that is made from a base of creamy yogurt, typically Greek yogurt, and frozen fruit. ","category": "desserts","rating": 4,"image_url": "https://www.notenoughcinnamon.com/wp-content/uploads/2021/03/Healthy-Frozen-Yogurt-Bark-3-500x500.jpg"}]
        self.assertEqual(recipes_expected, recipes_filtered_data)

    def test_filter_by_rating_recipes(self):
        recipe_management = RecipeManagement()
        rating = 4
        recipes_filtered_data = recipe_management.filter_recipes("", "", rating)
        recipes_expected = [{"id": 2,"name": "Frozen Yogurt Bark","description": "A tasty and healthy snack that is made from a base of creamy yogurt, typically Greek yogurt, and frozen fruit. ","category": "desserts","rating": 4,"image_url": "https://www.notenoughcinnamon.com/wp-content/uploads/2021/03/Healthy-Frozen-Yogurt-Bark-3-500x500.jpg"}]
        self.assertEqual(recipes_expected, recipes_filtered_data)
    ...
    def test_filter_by_all_fields(self):
        ...
        name = "yogurt"
        category = "desserts"
        recipes_filtered_data = recipe_management.filter_recipes(name, category, rating)
        recipes_expected = [{"id": 2,"name": "Frozen Yogurt Bark","description": "A tasty and healthy snack that is made from a base of creamy yogurt, typically Greek yogurt, and frozen fruit. ","category": "desserts","rating": 4,"image_url": "https://www.notenoughcinnamon.com/wp-content/uploads/2021/03/Healthy-Frozen-Yogurt-Bark-3-500x500.jpg"}]
        self.assertEqual(recipes_expected, recipes_filtered_data)
